IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'AddedInnovationChromeExtensionGetFormControlData')
DROP PROCEDURE [dbo].[AddedInnovationChromeExtensionGetFormControlData]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[AddedInnovationChromeExtensionGetFormControlData]
